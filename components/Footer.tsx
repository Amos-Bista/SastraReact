  ...
  return (
    <div className='bg-[#06192F] w-full h-72 text-white mt-10'>
      ...
      <div className='w-[65%] h-[40%] text-center border-t-2 m-auto pt-3'>
        ...
        <p className='text-xs pt-3'>Sastra Network Solution Inc. 1st floor, Dream Home Building Putalisadak, Kathmandu, Nepal | Phone: +977-1-5342523, +977-1-5342967, +977-1-5346317</p>
      </div>
